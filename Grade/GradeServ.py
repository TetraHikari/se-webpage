...
def student_set_score(root, username, subject, new_score):
    root[username].subjects[subject] = new_score
    commit()
...
def read_student_score(root, username):
    return root[username].get_subjects()
...
# add_student_subject(root, "65011610", "Computer Science", 0)
# add_student_subject(root, "65011610", "Database Management", 0)
# add_student_subject(root, "65011610", "Artificial Intelligence", 0)
# add_student_subject(root, "65011610", "Web Programming", 0)
# add_student_subject(root, "65011610", "Software Engineering", 0)

# add_student_subject(root, "65011611", "Computer Science", 0)
# add_student_subject(root, "65011611", "Database Management", 0)
# add_student_subject(root, "65011611", "Artificial Intelligence", 0)
# add_student_subject(root, "65011611", "Web Programming", 0)
# add_student_subject(root, "65011611", "Software Engineering", 0)

# add_student_subject(root, "65011612", "Computer Science", 0)
# add_student_subject(root, "65011612", "Database Management", 0)
# add_student_subject(root, "65011612", "Artificial Intelligence", 0)
# add_student_subject(root, "65011612", "Web Programming", 0)
# add_student_subject(root, "65011612", "Software Engineering", 0)

# add_student_subject(root, "65011613", "Computer Science", 0)
# add_student_subject(root, "65011613", "Database Management", 0)
# add_student_subject(root, "65011613", "Artificial Intelligence", 0)
# add_student_subject(root, "65011613", "Web Programming", 0)
# add_student_subject(root, "65011613", "Software Engineering", 0)

# add_student_subject(root, "65011614", "Computer Science", 0)
# add_student_subject(root, "65011614", "Database Management", 0)
# add_student_subject(root, "65011614", "Artificial Intelligence", 0)
# add_student_subject(root, "65011614", "Web Programming", 0)
# add_student_subject(root, "65011614", "Software Engineering", 0)
...
# for user in root:
#     for score in read_student_score(root, user):
#         print(f"Subject {user} : {score}")
